...
<div class="article">
	...
	<div style=" padding:1px; background-color:#CCCCCC; font-size:11px">
				<table width="1700" border="0" cellspacing="0" cellpadding="3px">
				  <form id="caricari" action="daftar_calon_terdaftar_lolos.php?stat=<?php echo"$stat"; ?>" method="POST"> 
    ...
    <?php if($pilihan!=0 && $jurusan!=0) { ?>
				...
				?>
				  <tr bgcolor="#FFFFFF">
					...
					if($dview1['lolos_stat']==1) { echo "<img src='./images/pass.png' width='16' title='Lolos'>"; }
					else  { echo "<img src='./images/pass_un.png' width='16' title='Tidak Lolos'>"; }
                    ?>
                    </span>
                    </td>
