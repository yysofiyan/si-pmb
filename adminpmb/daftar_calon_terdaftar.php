...
<div class="article">
	...
	<div style=" padding:1px; background-color:#CCCCCC; font-size:11px">
				<table width="1600px" border="0" cellspacing="1" cellpadding="3px">
				  <tr bgcolor="#C1C1C1">
				    ...
				    <td width="7%">No. KTP</td>
				    <td width="5%">Lokasi Test</td>
				    <td width="7%">No. HP/Telp</td>
				...
				$qview1 = "SELECT a.nomor_pendaftaran, a.nama_lengkap, a.tinggi_badan, a.berat_badan, a.tempat_lahir, 
						   ...
						   a.waktu_daftar, a.kode_setting, b.jurusan, a.cek_tinggi, a.no_ktp
				...
				?>
				  <tr bgcolor="#FFFFFF" valign="middle">
				    <td> <a href="form_formulir_pendaftaran_ubah.php?nopen=<?php echo "$dview1[0]"; ?>&amp;stat=ubah" title="Ubah Data Diri | Formulir"><img src="../images/paper&pencil_48.png" width="18" /></a> 
                         <a href="cetak_formulir.php?nopen=<?php echo "$dview1[0]"; ?>" title="Cetak Formulir" target="_blank"><img src="../images/printer_48.png" width="18" /></a> </td>
					<td>
                    <form action="#" onsubmit="return confirm ('Anda yakin akan mereset password <?php echo $dview1['nomor_pendaftaran']; ?>?')" method="post">
	...
	opendb();
	$query="UPDATE tb_pendaftaran SET password='$pass' WHERE nomor_pendaftaran='$id'";
	querydb($query);
	closedb();
	?>
