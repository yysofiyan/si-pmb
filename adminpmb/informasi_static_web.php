<div class="article">
	...
	{
	opendb();
	$qview = "SELECT * FROM informasi_statis_web WHERE kode_statis='$kode_setting'";
	$hview = querydb($qview);
	closedb();
	...
	<h2><?php if ($stat=="ubah") { echo"Informasi Statis Website - Ubah Data"; } elseif ($stat=="tambah") { echo"Informasi Statis Website - Tambah Data"; } else { echo"Informasi Statis Website"; } ?></h2>
	<?php if ($stat<>"") { ?>
	<form method="post" action="informasi_static_web_update.php" enctype="multipart/form-data" name="test">
	...
	<div style=" padding:1px;">
		      ...
		      <th width="11%">
              <!--
	  		<form method="post" action="index.php?page=informasi-static"  enctype="multipart/form-data" name="tambah" id="tambah">
            ...
            -->
				...
				$no=0;
				opendb();
				$qview1 = "SELECT * FROM informasi_statis_web";
				...
				?>
				  <tr bgcolor="#FFFFFF">
					...
					<td width="55%"><?php echo "$dview1[1]"; ?></td>
					<td width="25%"><?php echo date("d/m/Y", strtotime($dview1[3])); ?></td>
		      <td width="11%">
<form method="post" action="index.php?page=informasi-static"  enctype="multipart/form-data" name="ubah" id="ubah<?php echo"$dview1[0]"; ?>">
